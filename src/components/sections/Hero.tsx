...
export function Hero() {
  ...
  return (
    <section className="pt-8 lg:pt-20 text-center max-w-4xl mx-auto flex flex-col items-center gap-6 md:gap-8">
      <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold font-headline leading-tight tracking-tight px-4">
      ...
      <p className="text-lg md:text-2xl text-muted-foreground max-w-2xl px-6">
        Transforme qualquer foto comum em imagens que transmitem poder, status e presença. Sem câmeras caras ou estúdio.
      </p>

      {heroImage && (
        <div className="relative w-full max-w-md aspect-[9/14] rounded-2xl overflow-hidden shadow-2xl border-4 border-primary/10 transition-transform hover:scale-[1.02] duration-500 mx-4">
          <Image
