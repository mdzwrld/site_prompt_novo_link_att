...
export function Comparison() {
  return (
    <section id="comparisons" className="space-y-6 md:space-y-12 py-4 md:py-12 scroll-mt-24">
      ...
      <div className="flex flex-col gap-6 md:gap-16 max-w-5xl mx-auto px-4">
        {comparisons.map((item, idx) => (
          <div key={idx} className="flex flex-col items-center gap-4 md:gap-6 group">
            ...
            <p className="text-center font-bold text-primary text-sm md:text-xl italic transition-opacity duration-300">
